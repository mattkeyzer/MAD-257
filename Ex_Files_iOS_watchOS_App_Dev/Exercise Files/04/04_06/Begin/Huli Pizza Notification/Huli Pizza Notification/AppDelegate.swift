...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setCategories(){
        ...
        let pizzaStepsCategory = UNNotificationCategory(identifier: "pizza.steps.category", actions: [nextStepAction,snoozeAction,cancelAction], intentIdentifiers: [], options: [])
